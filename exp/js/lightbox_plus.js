...
function initLightbox() { 
	lightbox = new LightBox({
		loadingimg:'./index.php?view=lb&v=loading.gif',
		expandimg:'./index.php?view=lb&v=expand.gif',
		shrinkimg:'./index.php?view=lb&v=shrink.gif',
		previmg:'./index.php?view=lb&v=prev.gif',
		nextimg:'./index.php?view=lb&v=next.gif',
		effectimg:'./index.php?view=lb&v=zzoop.gif',
		effectpos:{x:-40,y:-20},
		effectclass:'./index.php?view=lb&v=effectable',
		closeimg:'./index.php?view=lb&v=close.gif',
		resizable:true
	});
}
